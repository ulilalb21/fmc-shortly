<template>
  ...
  <main class="pt-[104px]">
    ...
    <footer class="bg-gray-800 py-12 text-center text-white lg:py-20">
      <div class="container mx-auto lg:flex lg:justify-between lg:px-6 xl:px-0">
        <svg
          id="shorty-logo"
          class="mx-auto mb-12 fill-white lg:mx-0"
        ...
        <div class="lg:flex lg:gap-10">
          <div class="flex flex-col gap-9 lg:grid lg:grid-cols-3 lg:text-left">
            <div v-for="(links, key) in footerLinks">
              ...
              <a
                href="#"
                v-for="link in links"
                class="mb-2 block text-gray-400 hover:text-cyan-300"
                >{{ link }}</a
              >
            </div>
          </div>
          <div
            class="mt-8 flex w-full justify-center gap-7 lg:mt-0 lg:w-auto lg:justify-normal"
          >
            <div
              ...
              class="h-6 w-6 cursor-pointer bg-white hover:bg-cyan-500"
              style="
                mask-size: 100%;
